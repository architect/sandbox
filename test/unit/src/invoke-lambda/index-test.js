...
test('Set up env', t => {
  process.chdir(path.join(__dirname, '..', '..', '..', 'integration', 'mock', 'normal'))
...
test('Verify call counts', t => {
  t.plan(3)
  t.equals(nodeFake.callCount, 2, 'Node called correct number of times')
  t.equals(pythonFake.callCount, 2, 'Python called correct number of times')
